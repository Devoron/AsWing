 ...
 * @author iiley
 */
public class AlternativeScrollPaneLayout extends EmptyLayout{
	 ...
	 * @see #BOTTOM_RIGHT
	 */
	public function AlternativeScrollPaneLayout(style:int=BOTTOM_RIGHT){
		this.style = style;
	}
	
    override public function minimumLayoutSize(target:Container):IntDimension{
    	if(target is AlternativeScrollPane){
    		var scrollPane:AlternativeScrollPane = AlternativeScrollPane(target);
    		var size:IntDimension = getScrollButtonsSize(scrollPane);
    ...
    private function getScrollButtonsSize(scrollPane:AlternativeScrollPane):IntDimension{
    	//var vsb:JScrollBar = scrollPane.getVerticalScrollBar();
    	//var hsb:JScrollBar = scrollPane.getHorizontalScrollBar();
    	var size:IntDimension = new IntDimension(40);
    ...
    override public function preferredLayoutSize(target:Container):IntDimension{
    	if(target is AlternativeScrollPane){
	    	...
	    	size.increaseSize(getScrollButtonsSize(scrollPane));
	    	var viewport:Viewportable = scrollPane.getViewport();
	    	if(viewport != null){
