...
package org.aswing.plaf.basic
{
	...
	public class BasicFrameUI extends BaseComponentUI implements FrameUI
	{
		...
		private function isMaximizedFrame():Boolean
		{
			...
			return ((state & JFrame.MAXIMIZED_HORIZ) == JFrame.MAXIMIZED_HORIZ) || ((state & JFrame.MAXIMIZED_VERT) == JFrame.MAXIMIZED_VERT);
		}
		...
		private function __onTitleBarDoubleClick(e:Event):void
		{
			...
			if (frame.isResizable())
			{
				...
				if ((state & JFrame.MAXIMIZED_HORIZ) == JFrame.MAXIMIZED_HORIZ || (state & JFrame.MAXIMIZED_VERT) == JFrame.MAXIMIZED_VERT || (state & JFrame.ICONIFIED) == JFrame.ICONIFIED)
				{
