	...
	public class BasicSliderUI extends BaseComponentUI implements SliderUI
	{
		...
		protected function countTrackRect(b:IntRectangle):void
		{
			...
			if (isVertical())
			{
				...
				trackDrawRect.setRectXYWH(b.x + h_margin, b.y + v_margin, thumbSize.width - h_margin * 2, b.height - v_margin * 2);
				trackRect.setRectXYWH(b.x, b.y + v_margin, thumbSize.width, b.height - v_margin * 2);
			}
			else
			{
				...
				trackDrawRect.setRectXYWH(b.x + h_margin, b.y + v_margin, b.width - h_margin * 2, thumbSize.height - v_margin * 2);
				trackRect.setRectXYWH(b.x + h_margin, b.y, b.width - h_margin * 2, thumbSize.height);
			}
		}
		...
		protected function paintTrack(g:Graphics2D, drawRect:IntRectangle):void
		{
			...
			trackCanvas.filters = [BlurFilter.createGlow(0x0, style.shadowAlpha, 5, 0.6)];
		}
