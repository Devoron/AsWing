...
public class BasicLookAndFeel extends LookAndFeel{
	...
	protected function initCommonUtils(table:UIDefaults):void{
		...
		var cursors:Array = [
			"System.hResizeCursor", devoron.aswing3d.plaf.basic.cursor.H_ResizeCursor,
			"System.vResizeCursor", devoron.aswing3d.plaf.basic.cursor.V_ResizeCursor,
			"System.hvResizeCursor", devoron.aswing3d.plaf.basic.cursor.HV_ResizeCursor,
			"System.hMoveCursor", devoron.aswing3d.plaf.basic.cursor.H_ResizeCursor,
			"System.vMoveCursor", devoron.aswing3d.plaf.basic.cursor.V_ResizeCursor,
			"System.hvMoveCursor", devoron.aswing3d.plaf.basic.cursor.HV_ResizeCursor	
		];
	...
	protected function initComponentDefaults(table:UIDefaults):void{
		...
		var comDefaults:Array = [
			...
			"Button.bg", devoron.aswing3d.plaf.basic.background.ButtonBackground,
		...
		comDefaults = [
			...
			"Panel.bg", devoron.aswing3d.plaf.basic.background.PanelBackground, 
		...
		comDefaults = [
			...
			"ToggleButton.bg", devoron.aswing3d.plaf.basic.background.ToggleButtonBackground,
		...
		comDefaults = [
			...
			"RadioButton.icon", devoron.aswing3d.plaf.basic.icon.RadioButtonIcon,
		...
		comDefaults = [
			...
			"CheckBox.icon", devoron.aswing3d.plaf.basic.icon.CheckBoxIcon,
		...
		comDefaults = [
			...
			"ScrollBar.bg", devoron.aswing3d.plaf.basic.background.ScrollBarBackground,
			"ScrollBar.thumbDecorator", devoron.aswing3d.plaf.basic.background.ScrollBarThumb
		];
		table.putDefaults(comDefaults);
		...
		comDefaults = [
			...
			"ProgressBar.bg", devoron.aswing3d.plaf.basic.background.ProgressBarBackground, 
			"ProgressBar.fg", devoron.aswing3d.plaf.basic.background.ProgressBarIcon, 
	   ...
	   // *** TextField
		comDefaults = [
			...
			"TextField.bg", devoron.aswing3d.plaf.basic.background.TextComponentBackBround,
	   ...
	   // *** TextArea
		comDefaults = [
			...
			"TextArea.bg", devoron.aswing3d.plaf.basic.background.TextComponentBackBround,
		...
		comDefaults = [
			...
			"Frame.resizer", devoron.aswing3d.resizer.DefaultResizer, 
			...
			"Frame.bg", devoron.aswing3d.plaf.basic.background.FrameBackground, 
			"Frame.border", new EmptyBorderResource(null, new Insets(0, 6, 12, 12)), 
			"Frame.icon", devoron.aswing3d.plaf.basic.icon.TitleIcon, 
			"Frame.iconifiedIcon", devoron.aswing3d.plaf.basic.icon.FrameIconifiedIcon, 
			"Frame.normalIcon", devoron.aswing3d.plaf.basic.icon.FrameNormalIcon, 
			"Frame.maximizeIcon", devoron.aswing3d.plaf.basic.icon.FrameMaximizeIcon, 
			"Frame.closeIcon", devoron.aswing3d.plaf.basic.icon.FrameCloseIcon
		];
		table.putDefaults(comDefaults);		
		...
		comDefaults = [
			...
			"FrameTitleBar.icon", devoron.aswing3d.plaf.basic.icon.TitleIcon, 
			"FrameTitleBar.iconifiedIcon", devoron.aswing3d.plaf.basic.icon.FrameIconifiedIcon, 
			"FrameTitleBar.normalIcon", devoron.aswing3d.plaf.basic.icon.FrameNormalIcon, 
			"FrameTitleBar.maximizeIcon", devoron.aswing3d.plaf.basic.icon.FrameMaximizeIcon, 
			"FrameTitleBar.closeIcon", devoron.aswing3d.plaf.basic.icon.FrameCloseIcon
		];
		table.putDefaults(comDefaults);
		...
		comDefaults = [
			...
			"ToolTip.bg", devoron.aswing3d.plaf.basic.background.ToolTipBackground, 
		...
		comDefaults = [
			...
			"List.opaque", false, 
			"List.focusable", true, 
			"List.bg", devoron.aswing3d.plaf.basic.background.ListBackground, 
		...
		comDefaults = [
			...
			"ComboBox.popupBorder", devoron.aswing3d.plaf.basic.border.ComboBoxPopupBorder, 
			"ComboBox.bg", devoron.aswing3d.plaf.basic.background.InputBackground, 
		...
		comDefaults = [
			...
			"Slider.thumbIcon", devoron.aswing3d.plaf.basic.icon.SliderThumbIcon
		];
		table.putDefaults(comDefaults);
		...
		comDefaults = [
			...
			"Adjuster.thumbIcon", devoron.aswing3d.plaf.basic.adjuster.PopupSliderThumbIcon,
			"Adjuster.bg", devoron.aswing3d.plaf.basic.background.InputBackground, 
		...
		comDefaults = [
			...
			"Stepper.bg", devoron.aswing3d.plaf.basic.background.InputBackground, 
		...
		comDefaults = [
			...
			"ColorChooser.border", devoron.aswing3d.plaf.basic.border.ColorChooserBorder
		];
		table.putDefaults(comDefaults);		
	   ...
	   // *** JClosableTabbedPane
		...
		comDefaults = [
			...
			"Table.bg", devoron.aswing3d.plaf.basic.background.TableBackground,
		...
		comDefaults = [
			...
			"TableHeader.bg", devoron.aswing3d.plaf.basic.background.TableHeaderBackground, 
			"TableHeader.border", undefined, 
			"TableHeader.cellBorder", devoron.aswing3d.plaf.basic.border.TableHeaderCellBorder, 
		...
		comDefaults = [
			...
			"Tree.leafIcon", devoron.aswing3d.tree.TreeLeafIcon, 
			"Tree.folderExpandedIcon", devoron.aswing3d.tree.TreeFolderIcon, 
			"Tree.folderCollapsedIcon", devoron.aswing3d.tree.TreeFolderIcon, 
			"Tree.leftChildIndent", 10, 
			"Tree.rightChildIndent", 0, 
			"Tree.rowHeight", 16, 
			"Tree.expandControl", devoron.aswing3d.plaf.basic.tree.BasicExpandControl, 
	    ...
	    comDefaults = [
	    	...
	    	"MenuItem.arrowIcon", devoron.aswing3d.plaf.basic.icon.MenuItemArrowIcon,
	    	"MenuItem.checkIcon", devoron.aswing3d.plaf.basic.icon.MenuItemCheckIcon,
	    ...
	    comDefaults = [
	    	...
	    	"CheckBoxMenuItem.arrowIcon", devoron.aswing3d.plaf.basic.icon.MenuItemArrowIcon,
	    	"CheckBoxMenuItem.checkIcon", devoron.aswing3d.plaf.basic.icon.CheckBoxMenuItemCheckIcon,
	    ...
	    comDefaults = [
	    	...
	    	"RadioButtonMenuItem.arrowIcon", devoron.aswing3d.plaf.basic.icon.MenuItemArrowIcon,
	    	"RadioButtonMenuItem.checkIcon", devoron.aswing3d.plaf.basic.icon.RadioButtonMenuItemCheckIcon,
	    ...
	    comDefaults = [
	    	...
	    	"Menu.arrowIcon", devoron.aswing3d.plaf.basic.icon.MenuArrowIcon, 
	    	"Menu.checkIcon", devoron.aswing3d.plaf.basic.icon.MenuCheckIcon, 
	    ...
	    comDefaults = [
	    	...
	    	"PopupMenu.border", devoron.aswing3d.plaf.basic.border.PopupMenuBorder
	    ];
	    table.putDefaults(comDefaults);
