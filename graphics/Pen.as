...
package devoron.aswing3d.graphics
{
	 ...
	 * You can use pen to draw an ordinary shape. To draw gradient lines, refer to <code>devoron.aswing3d.graphics.GradientPen</code>
	 *
	 * @see devoron.aswing3d.graphics.IPen
	 * @see devoron.aswing3d.graphics.GradientPen
	...
	public class Pen implements IPen
	{
		 ...
		 * Create a Pen.
		 */
		public function Pen(color:ASColor, thickness:Number = 1, pixelHinting:Boolean = false, scaleMode:String = "normal", caps:String = null, joints:String = null, miterLimit:Number = 3)
		{
		...
		public function setTo(target:Graphics):void
		{
			...
			target.lineStyle(_thickness, _color.getRGB(), _color.getAlpha());
		}
	}
