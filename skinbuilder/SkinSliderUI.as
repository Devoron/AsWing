...
package org.aswing.skinbuilder
{
	...
	public class SkinSliderUI extends BasicSliderUI
	{
		...
		override protected function countTrackRect(b:IntRectangle):void
		{
			...
			if (isVertical())
			{
				trackDrawRect.setRectXYWH(b.x, b.y, thumbSize.width, b.height);
				trackRect.setRectXYWH(b.x, b.y + left, thumbSize.width, b.height - mwidth);
			}
			else
			{
				trackDrawRect.setRectXYWH(b.x, b.y, b.width, thumbSize.height);
				trackRect.setRectXYWH(b.x + left, b.y, b.width - mwidth, thumbSize.height);
			}
		}
