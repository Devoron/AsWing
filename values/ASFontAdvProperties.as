...
package org.aswing.values
{
	...
	public class ASFontAdvProperties
	{
		 ...
		 */
		public function ASFontAdvProperties(embedFonts:Object = false, antiAliasType:String = "normal", gridFitType:String = "pixel", sharpness:Object = 0, thickness:Object = 0)
		{
		...
		{
			if (null == this.antiAliasType)
				return false;
			if (null == this.embedFonts)
				return false;
			if (null == this.gridFitType)
				return false;
		...
		{
			return "ASFontAdvProperties[" + "embedFonts : " + embedFonts + ", antiAliasType : " + antiAliasType + ", gridFitType : " + gridFitType + ", sharpness : " + sharpness + ", thickness : " + thickness + "]";
		}
	}
}