...
package org.aswing.values
{
	...
	public class ASFont
	{
		 ...
		 */
		public function ASFont(nameOrTextFormat:* = "Tahoma", size:Number = 11, bold:Boolean = false, italic:Boolean = false, underline:Boolean = false, embedFontsOrAdvancedPros:* = null)
		{
		...
		{
			return "ASFont[" + "textFormat : " + textFormat + "]";
		}
	}
