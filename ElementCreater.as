package org.aswing
{
	...
	public class ElementCreater
	{
		...
		public function ElementCreater()
		{
		}
		...
		{
			if (depth == 0)
				depth = DepthManager.getNextAvailableDepth(position_mc);
			var result_mc:MovieClip = new MovieClip();
			position_mc.setChildIndex(result_mc, depth);
			result_mc.name = name;
			//position_mc.createEmptyMovieClip(name, depth);
		...
		public function attachMCWithName(position_mc:MovieClip, linkage:String, name:String, depth:Number):MovieClip
		{
			...
			result_mc.name = name;
			position_mc.setChildIndex(result_mc, depth);
			//position_mc.attachMovie(linkage, name, depth);
			initObjectParams(result_mc, _defaultMovieClip);
			return result_mc;
		}
		...
		public function createTFWithName(position_mc:MovieClip, name:String, depth:Number):TextField
		{
			...
			position_mc.setChildIndex(result_txt, depth);
