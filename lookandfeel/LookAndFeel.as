...
package org.aswing.lookandfeel
{
	...
	public class LookAndFeel
	{
		 ...
		 */
		public static function installColors(c:Component, componentUIPrefix:String, defaultBgName:String = "background", defaultFgName:String = "foreground", defaultMgName:String = "mideground"):void
		{
		 ...
		 */
		public static function installColorsAndFont(c:Component, componentUIPrefix:String, defaultBgName:String = "background", defaultFgName:String = "foreground", defaultFontName:String = "font", defaultMgName:String = "mideground", defaultCaName:String = "colorAdjust"):void
		{
