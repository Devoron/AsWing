...
public class JToolTip extends Container{
	...
	public function JToolTip() {
		...
		timer = new ASTimer(WAIT_TIME, false);
	...
	private function viewToolTip():void{
		...
		if(offsetsRelatedToMouse){
			var gp:flash.geom.Point = containerPane.localToGlobal(new Point(containerPane.mouseX, containerPane.mouseY));
