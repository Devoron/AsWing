...
import org.aswing.layout.AlternativeScrollPaneLayout;
import org.aswing.LayoutManager;
import org.aswing.Orientable;
import org.aswing.plaf.basic.AlternativeScrollPaneUI;
 ...
 * @author iiley
 */	
public class AlternativeScrollPane extends Container implements Orientable{
	
	/**
     * scrollbar are displayed only when needed.
     */
    public static const SCROLLBUTTON_AS_NEEDED:int = 0;
    /**
     * scrollbar are never displayed.
     */
    public static const SCROLLBUTTON_NEVER:int = 1;
    /**
     * scrollbar are always displayed.
     */
    public static const SCROLLBUTTON_ALWAYS:int = 2;
	 ...
	 * @param max
	 */
	public function AlternativeScrollPane(viewOrViewport:*=null, orientation:int=AsWingConstants.VERTICAL, 
		value:int=0, extent:int=10, min:int=0, max:int=100){
		super();
		setName("AlternativeScrollPane");
		unitIncrement = 1;
		...
		/*var btn:JButton = new JButton("dsfsd");
		insertImp( -1, btn);
		revalidate();*/
		...
		setLayout(new AlternativeScrollPaneLayout());
    ...
    override public function getDefaultBasicUIClass():Class{
    	return org.aswing.plaf.basic.AlternativeScrollPaneUI;
    }
	
	override public function getUIClassID():String{
		//return "AlternativeScrollPaneUI";
		return "AlternativeScrollPaneUI";
	}
	
	/**
	 * @throws ArgumentError when the layout is not AlternativeScrollPaneLayout instance.
	 */
	override public function setLayout(layout:LayoutManager):void{
		if(layout is AlternativeScrollPaneLayout){
			super.setLayout(layout);
		}else{
			throw new ArgumentError("Only can set AlternativeScrollPaneLayout to JScrollPane");
		}
	}
	...
	//___________________________________ Тут начинается то, что позаимствовано у скроллбара
