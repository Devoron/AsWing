...
package org.aswing
{
	...
	public class JColorChooser extends AbstractColorChooserPanel
	{
		...
		private var sight2DButton:JToggleButton;
		private var sight3DButton:JToggleButton;
		...
		public function JColorChooser()
		{
			...
			sight2DButton = new JToggleButton();
			sight3DButton = new JToggleButton();
		...
		public function getSight2DButton():JToggleButton {
			return sight2DButton;
		}
		
		public function getSight3DButton():JToggleButton {
			return sight3DButton;
		}
		 ...
		 */
		public static function showDialog(component:Component, title:String, initialColor:ASColor, modal:Boolean = true, okHandler:Function = null, cancelHandler:Function = null, location:IntPoint = null):JColorChooser
		{
			var chooser:JColorChooser = new JColorChooser();
			chooser.setSelectedColor(initialColor);
			var frame:JFrame = createDialog(chooser, component, title, modal, okHandler, cancelHandler);
		 ...
		 */
		public static function createDialog(chooser:JColorChooser, component:Component, title:String, modal:Boolean = true, okHandler:Function = null, cancelHandler:Function = null):JFrame
		{
