...
package org.aswing
{
	...
	public class JTextComponent extends Component implements EditableComponent
	{
		...
		public static var customContextMenu:IContextMenu;
		...
		public function JTextComponent()
		{
			...
			if (customContextMenu)
				customContextMenu.addTargetComponent(this);
				//textField.addEventListener(MouseEvent.RIGHT_CLICK, __onMouseRightClick);
		}
		
		private function __onMouseRightClick(e:MouseEvent):void
		{
			//customContextMenu.setLocationXY(e.stageX, e.stageY);
			//customContextMenu.setVisible(true);
		}
		
		private function __onTextComponentTextInput(e:TextEvent):void
		{
			if (!getTextField().multiline)
		...
		public function setAntiAliasType(type:String):void
		{
			textField.antiAliasType = type;
		}
